(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('ngx-toastr'), require('rxjs/Observable'), require('@angular/material'), require('@angular/common/http'), require('@angular/flex-layout'), require('@angular/common')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', 'ngx-toastr', 'rxjs/Observable', '@angular/material', '@angular/common/http', '@angular/flex-layout', '@angular/common'], factory) :
	(factory((global['fs-message'] = {}),global.core,global.ngxToastr,global.Observable,global.material,global.http,global.flexLayout,global.common));
}(this, (function (exports,core,ngxToastr,Observable,material,http,flexLayout,common) { 'use strict';
...
var FsMessageComponent = (function () {
    ...
    FsMessageComponent.propDecorators = {
        "fsType": [{ type: core.Input, args: ['fsType',] },],
        "fsMessage": [{ type: core.Input, args: ['fsMessage',] },],
    };
